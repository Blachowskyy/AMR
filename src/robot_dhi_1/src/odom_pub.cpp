...
ROS_INFO_STREAM("d_t= "<< d_t);
ROS_INFO_STREAM("x_k(0,0)= "<< x_k(0,0)<<" x_k(1,0)"<< x_k(1,0) <<" x_k(2,0)= "<<x_k(2,0));
ROS_INFO_STREAM("x_k1(0,0)= "<< x_k1(0,0)<<" x_k1(1,0)"<< x_k1(1,0) <<" x_k1(2,0)= "<<x_k1(2,0));
