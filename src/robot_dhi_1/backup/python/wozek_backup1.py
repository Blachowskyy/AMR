...
class WozekModbusDriver:
    def __init__(self):
        ...
        try:
            ...
            self.pub_comand_curtis_vel = rospy.Publisher('wozek_angle_tick',Int64, queue_size=100, latch=True) 
            self.pub_comand_servo_angle = rospy.Publisher('servo_angle_tick', Int64, queue_size=100, latch=True)
